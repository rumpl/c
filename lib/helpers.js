 ...
 * @param node The single file.
 * @param nodeComment The comment for that file.
 * @param maxLine The length of the longest filename in the specified directory.
 */
 ...
 * @param files An array of all of the file names in the specified directory.
 * @param comments An array of all of the comments in the specified directory.
 */
